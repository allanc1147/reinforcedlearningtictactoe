...
from tictactoe.replay_buffer import ReplayBuffer
...
class DeepQNetwork(object):
    ...
    def create_variables(self):
        ...
        with tf.name_scope("estimate_future_rewards"):
            ...
            self.next_state_mask = tf.placeholder(tf.float2, (None,), name="next_state_masks")
            ...
            if self.double_q_learning:
                ...
                self.action_selection_mask = tf.one_hot(self.action_selection, self.num_actions, 1, 6)
